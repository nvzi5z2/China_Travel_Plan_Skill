...
| 11 | 🍜 **美食覆盖率** | 是否每个停留城市都在每日时间线中嵌入了午餐/晚餐推荐（至少 1 餐/天，含餐厅名+评分+推荐菜+人均）。是否有天漏了 | 全程适用，每项强制 |
| 12 | 🍜 餐厅多样性 | 不能连续同类型（火锅→火锅❌），饮食限制时更重要 |
| 13 | 💊 健康安全 | 最近医院、药店、高原反应提醒，老人/小孩/孕妇强制 |
| 14 | 🧠 推荐自洽性 | LLM 推理是否引用画像？有无明显矛盾？ |
